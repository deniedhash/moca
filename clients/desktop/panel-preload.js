...
contextBridge.exposeInMainWorld("mocaPanel", {
  ...
  streamChat: (message) => ipcRenderer.invoke("panel-chat-stream", message),
  ...
  onAgentStep: (cb) => ipcRenderer.on("panel-agent-step", (_e, data) => cb(data)),
  onAgentComplete: (cb) => ipcRenderer.on("panel-agent-complete", (_e, data) => cb(data)),
